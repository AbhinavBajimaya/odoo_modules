odoo.define('theme_nextbiz.bizcommon_editor_js', function(require) {
    'use strict';
    ...
    ajax.loadXML('/theme_nextbiz/static/src/xml/bizople_theme_common.xml', qweb);
    ajax.loadXML('/theme_nextbiz/static/src/xml/button_editor.xml', qweb);
    ...
    options.registry.health_blog_custom_snippet = options.Class.extend({
        start: function(editMode) {
            ...
            if (!editMode) {
                self.$el.find(".health_blog_slider").on("click", _.bind(self.theme_nextbiz_blog_slider, self));
            }
        },
        onBuilt: function() {
            var self = this;
        ...
        theme_nextbiz_blog_slider: function(type, value) {
            ...
            if (type != undefined && type.type == "click" || type == undefined) {
                self.$modal = $(qweb.render("theme_nextbiz.bizcommon_blog_slider_block"));
                ...
                ajax.jsonRpc('/theme_nextbiz/blog_get_options', 'call', {}).then(function(res) {
    ...
    options.registry.theme_nextbiz_blog_custom_snippet = options.Class.extend({
        start: function(editMode) {
            var self = this;
            this._super();
            this.$target.removeClass("o_hidden");
            ...
            if (!editMode) {
                self.$el.find(".bizcommon_blog_slider").on("click", _.bind(self.theme_nextbiz_blog_slider, self));
            }
        },
        onBuilt: function() {
            var self = this;
    ...
    options.registry.s_bizople_theme_blog_slider_snippet = options.Class.extend({
        start: function(editMode) {
            ...
            if (!editMode) {
                self.$el.find(".blog_slider_owl").on("click", _.bind(self.theme_nextbiz_blog_slider, self));
            }
        },
        onBuilt: function() {
            var self = this;
    ...
    options.registry.blog_3_custom_snippet = options.Class.extend({
        start: function(editMode) {
            ...
            if (!editMode) {
                self.$el.find(".blog_3_custom").on("click", _.bind(self.theme_nextbiz_blog_slider, self));
            }
        },
        onBuilt: function() {
            var self = this;
    ...
    options.registry.blog_4_custom_snippet = options.Class.extend({
        start: function(editMode) {
            ...
            if (!editMode) {
                self.$el.find(".blog_4_custom").on("click", _.bind(self.theme_nextbiz_blog_slider, self));
            }
        },
        onBuilt: function() {
            var self = this;
    ...
    options.registry.blog_6_custom_snippet = options.Class.extend({
        start: function(editMode) {
            ...
            if (!editMode) {
                self.$el.find(".blog_6_custom").on("click", _.bind(self.theme_nextbiz_blog_slider, self));
            }
        },
        onBuilt: function() {
            var self = this;
    ...
    options.registry.blog_5_custom_snippet = options.Class.extend({
        start: function(editMode) {
            ...
            if (!editMode) {
                self.$el.find(".blog_5_custom").on("click", _.bind(self.theme_nextbiz_blog_slider, self));
            }
        },
        onBuilt: function() {
            var self = this;
    ...
    options.registry.blog_8_custom_snippet = options.Class.extend({
        start: function(editMode) {
            ...
            if (!editMode) {
                self.$el.find(".blog_8_custom").on("click", _.bind(self.theme_nextbiz_blog_slider, self));
            }
        },
        onBuilt: function() {
            var self = this;
